...
@include('front.index4.header4')

@include('front.loader')

<secction class="theme-slider section-py-space">
                            ...
                            <div class="slider-banner slide-banner-3">
                                <div class="slider-img">
                                    <ul class="layout4-slide-1">
                                        <li id="img-1"><img src="../assets/images/layout-4/slider/1.1.png" class="img-fluid" alt="slider"></li>
                                    </ul>
                                </div>
                            ...
                            <div class="slider-banner slide-banner-3">
                                <div class="slider-img">
                                    <ul class="layout4-slide-2">
                                        <li id="img-2"><img src="../assets/images/layout-4/slider/1.2.png" class="img-fluid" alt="slider"></li>
                                    </ul>
                                </div>
                                <div class="slider-banner-contain">
                                    <div>
                            ...
                            <div class="slider-banner slide-banner-3">
                                <div class="slider-img">
                                    <ul class="layout4-slide-3 ">
                                        <li id="img-3" class="slide-center"><img src="../assets/images/layout-4/slider/1.3.png" class="img-fluid" alt="slider"></li>
                                    </ul>
                                </div>
                                <div class="slider-banner-contain">
                                    <div>
                ...
                <div class="col-md-4  ">
                    <div class="collection-banner-main p-left  height-equal">
                        <div class="collection-img">
                            <img src="../assets/images/layout-4/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                        </div>
                                ...
                                <div class="row hot-deal-subcontain">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="hotdeal-right-slick">
                                            ...
                                            <div><img src="../assets/images/layout-2/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row hot-deal-subcontain">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="hotdeal-right-slick">
                                            <div><img src="../assets/images/layout-2/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div><img src="../assets/images/layout-2/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div><img src="../assets/images/layout-2/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div><img src="../assets/images/layout-2/hot-deal/8.jpg" alt="hot-deal" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
        ...
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="../assets/images/layout-4/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>wooden</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="../assets/images/layout-4/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>canon</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="../assets/images/layout-4/collection-banner/5.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>women</h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="../assets/images/layout-4/product/3.jpg" alt="quick" class="img-fluid "></div>
                    </div>
