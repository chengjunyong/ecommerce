          ...
          <form class="theme-form" method="POST" action="{{ route('register') }}">
            ...
            <div class="form-row">
              <div class="col-md-12 form-group">
                ...
                <input type="text" class="form-control @if($errors->first('contact')) is-invalid @endif" value="{{ old('contact') }}" name="contact" placeholder="Contact Number" required="" autocomplete="off">
