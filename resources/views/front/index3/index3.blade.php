                ...
                <div class="col">
                    <div class="slide-1 no-arrow">
                        <div>
                            <div class="slider-banner slide-banner-2 p-center">
                                <div class="slider-img">
                                    <ul class="layout3-slide-1">
                                        <li id="img-1"><img src="../assets/images/layout-3/slider/1.1.png" class="img-fluid" alt="slider"></li>
                                        <li id="img-2"><img src="../assets/images/layout-3/slider/1.2.png" class="img-fluid" alt="slider"></li>
                                    </ul>
                                </div>
                        ...
                        <div>
                            <div class="slider-banner slide-banner-2 p-center">
                                <div class="slider-img">
                                    <ul class="layout3-slide-2">
                                        <li id="img-3"><img src="../assets/images/layout-3/slider/2.1.png" class="img-fluid" alt="slider"></li>
                                        <li id="img-4"><img src="../assets/images/layout-3/slider/2.2.png" class="img-fluid" alt="slider"></li>
                                    </ul>
                                </div>
                                <div class="slider-banner-contain">
                                    <div class="sub-contain">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="row banner-2-padding collection4">
                    <div class="col-6 ">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                    ...
                    <div class="col-6 ">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain">
                                <div>
                                    <h3>canon</h3>
                ...
                <div class="row banner-3-padding collection4">
                    <div class="col-6 ">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>new</h3>
                    ...
                    <div class="col-6">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>boys</h3>
                ...
                <div class="row ">
                    <div class="col-12">
                        <div class="collection-banner-main banner-3 p-center ">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/5.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                ...
                <div class="row banner-2-padding  collection5 ">
                    <div class="col-lg-12 col-md-6 ">
                        <div class="collection-banner-main banner-4 p-left">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/6.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>lG</h3>
                    ...
                    <div class="col-lg-12 col-md-6 ">
                        <div class="collection-banner-main banner-4 p-left">
                            <div class="collection-img">
                                <img src="../assets/images/layout-3/collection-banner/7.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div >
                                    <h3>jewellery</h3>
                            ...
                            <div class="product-slide-6 product-m no-arrow">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/2.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/3.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/4.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/5.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/6.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/7.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="../assets/images/layout-3/product/8.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
        ...
        <div class="row layout-3-hotdeal">
            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                <div class="media-banner b-g-white1 border-0 banner-inverse">
                    ...
                    <div class="media-banner-box">
                        <div class="media">
                            <img src="../assets/images/layout-1/media-banner/4.jpg" class="img-fluid
                         " alt="banner">
                            <div class="media-body">
                                <div class="media-contant">
                                    <div>
                                ...
                                <div class="row hot-deal-subcontain">
                                    <div class="col-lg-4 col-sm-3 ">
                                        <div class="hotdeal-right-slick-1 no-arrow">
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/5.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2  col-sm-2">
                                        <div class="hotdeal-right-nav-1">
                                            <div><img src="../assets/images/layout-3/hot-deal/5.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="../assets/images/layout-3/hot-deal/7.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="../assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="../assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid   "></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row hot-deal-subcontain">
                                    <div class="col-lg-4 col-sm-3">
                                        <div class="hotdeal-right-slick-1 no-arrow">
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/6.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="../assets/images/layout-3/hot-deal/3.jpg" alt="hot-deal" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-7">
                                        <div class="hot-deal-center">
                                    ...
                                    <div class="col-lg-2  col-sm-2 ">
                                        <div class="hotdeal-right-nav-1">
                                            <div><img src="../assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="../assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="../assets/images/layout-3/hot-deal/6.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="../assets/images/layout-3/hot-deal/3.jpg" alt="hot-deal" class="img-fluid   "></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row layout-3-collection">
            <div class="col-md-6 ">
                <div class="collection-banner-main banner-7 p-left">
                    <div class="collection-img">
                        <img src="../assets/images/layout-3/collection-banner/11.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>Video Camera</h3>
            ...
            <div class="col-md-6">
                <div class="collection-banner-main banner-7 p-left">
                    <div class="collection-img">
                        <img src="../assets/images/layout-3/collection-banner/12.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>Furniture</h3>
        ...
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="../assets/images/layout-3/collection-banner/8.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>men</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="../assets/images/layout-3/collection-banner/9.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>sport</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="../assets/images/layout-3/collection-banner/10.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>army</h3>
                ...
                <div class="row sosiyal-contain">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="app-link-group">
                            <div class="app-item">
                                <img src="../assets/images/layout-1/app/1.png" class="img-fluid" alt="app">
                            </div>
                            <div class="app-item">
                                <img src="../assets/images/layout-1/app/2.png" class="img-fluid" alt="app">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-box">
                            ...
                            <div class="footer-contant mobile-contant">
                                <div class="logo-img">
                                    <img src="../assets/images/layout-3/logo/logo2.png" class="img-fluid  " alt="logo">
                                </div>
                                ...
                                <ul class="paymant-bottom">
                                    ...
                                    <li><a href="#"><img src="../assets/images/layout-1/pay/5.png" class="img-fluid" alt="payment"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="../assets/images/layout-3/product/a3.jpg" alt="" class="img-fluid "></div>
                    </div>
