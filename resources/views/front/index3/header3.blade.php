                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                                ...
                                <div class="nav-left" >
                                    ...
                                    <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                        <ul class="nav-cat title-font">
                                            ...
                                            <li class="mor-slide-click">
                                                <a>mor category <i class="fa fa-angle-down pro-down"></i><i class="fa fa-angle-up pro-up"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="logo-block">
                                <a class="#">
                                    <img src="../assets/images/layout-3/logo/logo.png" class="img-fluid  " alt="logo">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="menu-nav">
                                ...
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap desc-horizontal sm-vertical sm-blue">
                                        ...
                                        <!--HOME-->
                                        <li>
                                            <a href="#" class="desc-menu-item">Home</a>
                                            <ul>
                                        ...
                                        <!--SHOP-->
                                        <li>
                                            <a href="#" class="desc-menu-item">shop</a>
                                            <ul>
                                        ...
                                        <!--product-meu start-->
                                        <li class="mega" >
                                            <a href="#" class="desc-menu-item">product
                                        </a>
                                        ...
                                        <li class="mega" id="hover-cls">
                                            <a href="#" class="desc-menu-item">features</a>
                                        ...
                                        <!--pages-meu start-->
                                        <li><a href="#" class="desc-menu-item">pages</a>
                                            <ul>
                                                <li>
                                                    <a href="#">account</a>
                                                    <ul>
                                        ...
                                        <!--blog-meu start-->
                                        <li>
                                            <a href="#" class="desc-menu-item">blog</a>
                                            <ul>
