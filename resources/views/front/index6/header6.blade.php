                                                ...
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row menu-banner">
                                                            <div class="col-lg-6">
                                                                <div>
                                                                    <img src="{{ asset('assets/images/1_menu-banner1.jpg') }}" alt="menu-banner" class="img-fluid">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div>
                                                                    <img src="{{ asset('assets/images/1_menu-banner2.jpg') }}" alt="menu-banner" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
