...
<body>
  ...
  <div class="page-wrapper">
          ...
          <div class="card-body">
            ...
            <div class="tab-content" id="top-tabContent">
              <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                <form class="form-horizontal auth-form" method="POST" action="{{ route('adminLogin') }}">
                  @csrf
                  <div class="form-group">
                    <input required name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Username" >
                    @error('email')
    ...
    <!-- <a href="{{ route('getHome') }}" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>Back</a> -->
  </div>
</div>
</div>
