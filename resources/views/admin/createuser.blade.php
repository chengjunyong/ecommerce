                ...
                <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                  <div class="needs-validation user-add">
                    ...
                    <div class="form-group row">
                      ...
                      <input class="form-control col-xl-8 col-md-7" name="password_confirmation" type="password" required="">
                    </div>
                    <div class="form-group row">
                      <label for="validationCustom4" class="col-xl-3 col-md-4"><span>*</span> User Type</label>
                      <select class="form-control col-xl-8 col-md-7" name="user_type">
                        <option value="2">Manager</option>
                        <option value="3">Staff</option>
                        <option value="4">Staff ( Packing )</option>
                        <option value="5">Staff ( Driver )</option>
                      </select>
                    </div>
                  </div>
                </div>
